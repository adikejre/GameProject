...
// some sounds
const hitSound = new Audio( "/static/img/hitSound.wav");
const scoreSound = new Audio("/static/img/scoreSound.wav");
const wallHitSound = new Audio('/static/img//wallHitSound.wav');
...
function render() {
  ...
  drawNet();
  // draw user score
  drawScore(canvas.width / 4, canvas.height / 6, user.mscore);
  // draw ai score
  drawScore(3 * canvas.width / 4, canvas.height / 6, ai.mscore);
  // draw user paddle
